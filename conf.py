...
BLOG_AUTHOR = "Lars Augensen"  # (translatable)
BLOG_TITLE = "The Tinkerer"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://tinkerer.digitalhjemmehjelp.no/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://tinkerer.digitalhjemmehjelp.no/"
BLOG_EMAIL = "gneser@duck.com"
BLOG_DESCRIPTION = "Documenting what I learn along the way."  # (translatable)
...
# is in the manual.
COMMENT_SYSTEM_ID = "subhappy/tinkerer"
